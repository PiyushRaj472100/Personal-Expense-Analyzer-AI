            ...
            <div className="card bg-gradient-to-br from-primary-50 via-white to-accent-yellow/30 border-primary-200">
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-bold text-ink mb-3">AI Analysis & Insights</h3>
                  <div className="space-y-3">
                    {Array.isArray(data.ai_summary) ? (
                      data.ai_summary.map((tip, index) => (
                        <div
                          key={index}
                        ...
                        >
                          <p className="text-sm text-ink/90">{tip.message || tip}</p>
                          {tip.severity && (
                            <span
